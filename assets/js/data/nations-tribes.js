...
(function () {
  ...
  P.push(
    ...
    },
    {
      ...
      named: false, era: "Revelation in Mecca", group: "Nations & Tribes", depth: "supporting", isCommunity: true,
      names: { tradition: "بَنُو هَاشِم (Banū Hāshim)", arabic: "the clan of Hāshim within Quraysh" },
      archetypes: ["faithful-companion", "truth-seeker"],
      story: ["Banu Hashim were the honoured clan of Quraysh entrusted with feeding and watering the pilgrims to the Kaʿba. From this house came the Prophet Muhammad, and it was his kinsmen of Banu Hashim — believers and unbelievers alike — who largely shielded him in his early mission, enduring with him the years of boycott in the valley. Within the same clan stood his bitterest opponent, his uncle Abu Lahab, whose enmity the Quran singles out."],
      lessons: ["Kinship can be both a shield for truth and a test against it."],
      sources: ["quran", "tradition", "historical"],
      entries: [
        b("quran", "Referenced as the Prophet's nearest kin, whom he was commanded to warn — 'And warn your nearest kindred'; his uncle of the clan, Abu Lahab, is condemned by epithet.", "Q 26:214; Q 111:1–5", "Surahs al-Shuʿarāʼ, al-Masad"),
        ...
        b("historical", "A clan of Quraysh holding the offices of siqāya and rifāda — providing water and food for the pilgrims.", "Ibn Hishām; historical accounts", "History")
      ],
      encounters: [
